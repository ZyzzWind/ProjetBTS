...
{
    char request[170];
    sprintf(request,"curl -o /home/hugo/Téléchargements/tri/ESSAI_tri/test/tmp/donnees_veilles.json 'http://api.pioupiou.fr/v1/archive/%d?start=%d-%02d-%02dT23:30:00&stop=%d-%02d-%02d&format=json'",nb_pioupiou,
                                                                                                                                                                                                  annees,
                                                                                                                                                                                                  mois,
                                                                                                                                                                                                  jour-1,
                                                                                                                                                                                                  annees,
