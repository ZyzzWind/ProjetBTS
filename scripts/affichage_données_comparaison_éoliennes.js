...
var balise_g = document.getElementsByClassName("data");
balise_g[0].addEventListener("mouseover", mouseOver);
balise_g[0].addEventListener("mouseout", mouseOut);
balise_g[0].addEventListener("mousemove", mouseMove);
...
{ 
    ...
    var text2 = document.createTextNode('Puissance Produite: '+Math.round(production[0])+" MW");
